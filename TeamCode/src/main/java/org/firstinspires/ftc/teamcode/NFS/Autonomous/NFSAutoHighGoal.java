...
public class NFSAutoHighGoal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        traj[1][0] = drive.trajectoryBuilder(startPose, false)
                ...
                .build();
        traj[1][1] = drive.trajectoryBuilder(traj[1][0].end(), false)
                .splineTo(new Vector2d (-2, -36), Math.toRadians(-2))
                .build();
        traj[1][2] = drive.trajectoryBuilder(traj[1][1].end(), false)
                ...
                .build();
        traj[1][3] = drive.trajectoryBuilder(traj[1][2].end(), false)//wobble drop
                .splineTo(new Vector2d(-24, -55), Math.toRadians(-20))
                .splineTo(new Vector2d(15, -50), Math.toRadians(45))
